# RailsAdmin config file. Generated on January 29, 2012 19:23
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Seo Manager Aa', 'Admin']
  ...
  # config.excluded_models = [AdminUser, Customer, Website]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [AdminUser, Customer, Website]
  ...
  #     configure :active_admin_comments, :has_many_association         # Hidden   #   # Found columns:
  #     configure :id, :integer 
